...
namespace HelpStockApp.Domain.Test
{
    ...
    public class ProductUnitTest
    {
        ...
        {
            Action action = () => new Product("Placa Mãe", "Placa mãe Asrock steel legend am4", 600.00, 3, "http://surl.li/ycatry");
        ...
        public void CreateProduct_WithInvalidParemetersId_ResultException()
        {
            ...
            Action action = () => new Product(-1, "Placa Mãe", "Placa mãe Asrock steel legend am4", 600.00, 3, imageUrl);
        ...
        {
            var imageUrl = "http://surl.li/ycatry";
            Action action = () => new Product(1, "Pl", "Placa mãe Asrock steel legend am4", 600.00, 3, imageUrl);
            action.Should().Throw<DomainExceptionValidation>()
        ...
        {
            var imageUrl = "http://surl.li/ycatry";
            Action action = () => new Product(1, null, "Placa mãe Asrock steel legend am4", 600.00, 3, imageUrl);
            action.Should().Throw<DomainExceptionValidation>()
        ...
        public void CreateProduct_With_Too_Long_Image_URL_ResultException()
        {
            ...
            Action action = () => new Product(1, "Placa Mãe", "Placa mãe Asrock steel legend am4", 600.00, 3, longImageUrl);
            action.Should().Throw<DomainExceptionValidation>()
        ...
        {
            Action action = () => new Product(1, "Placa Mãe", "Placa mãe Asrock steel legend am4", 600.00, 3, null);
        ...
        {
            var emptyImageUrl = "";
            Action action = () => new Product(1, "Placa Mãe", "Placa mãe Asrock steel legend am4", 600.00, 3, emptyImageUrl);
            action.Should().Throw<DomainExceptionValidation>()
        ...
        {
            var imageUrl = "http://surl.li/ycatry";
            Action action = () => new Product(1, "Placa Mãe", "", 600.00, 3, imageUrl);
            action.Should().Throw<DomainExceptionValidation>()
        ...
        {
            var imageUrl = "http://surl.li/ycatry";
            Action action = () => new Product(1, "Placa Mãe", null, 600.00, 3, imageUrl);
        ...
        {
            var imageUrl = "http://surl.li/ycatry";
            Action action = () => new Product(1, "Placa Mãe", "Pla", 600.00, 3, imageUrl);
